...
// En producción, reemplace por fetch a su API.
...
$(async function(){
  ...
  tabla = $('#tabla').DataTable({
    data: originalData,
    autoWidth: false,
    scrollX: true,           // Fuerza scroll horizontal
    scrollCollapse: true,
    paging: true,
    columns: [
      { data: 'Delito' },
      { data: 'Factor' }, // Lugar
      { // Estrategia: hipervínculo con EnlaceUrl
        data: 'Institucion',
      ...
      { data: 'Descripcion' },   // Texto largo, con wrap vía CSS
